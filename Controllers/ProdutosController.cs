...
namespace AspCoreHttpTestJuniorElian.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public ProdutosController(AspCoreHttpTestJuniorElianContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoID,Descricao,Preco,Qtde")] Produto produto)
        {
